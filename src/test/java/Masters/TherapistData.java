...
public class TherapistData {
    ...
    public static class TherapistScenario {
        ...
        public String experienceDetails; // Experience Details
    ...
    private static TherapistScenario getPositiveBase() {
        ...
        s.experienceDetails = "Detailed professional summary and focus areas.";
    ...
    private static TherapistScenario copy(TherapistScenario base, String newName) {
        ...
        c.yearsOfExperience = base.yearsOfExperience;
        c.count = base.count;
    ...
    public static List<TherapistScenario> getScenarios() {
        ...
        /*
         * // 1. Name
         * String[] nTitles = { "", " ", "12345", "@#$%^", "A", "A".repeat(256),
         * "<script>alert(1)</script>" };
         * String[] nTitlesObjs = { " Titles Empty", " Titles Space", " Titles Numeric",
         * " Titles Special",
         * " Titles Short",
         ...
         * 
         * // 2. Phone Number
         * String[] nPhones = { "", "123", "ABC", "987654321123", "phone12",
         * "98@76#432", " " };
         * String[] nPhoneObjs = { " phone Empty", " phone Short", " phone Alpha",
         * " phone TooLong", " phone Mixed",
         ...
         * String[] nDescObjs = { " desc Empty", " desc ShortText", " desc Special",
         * " desc ScriptTag" };
         ...
         * String[] nCountObjs = { " count Empty", " count Space", " count Zero",
         * " count Negative", " count Alpha",
         ...
         * String[] nLeadObjs = { " lead Empty", " lead Negative", " lead Alpha",
         * " lead Float", " lead Special",
         * " lead LeadingZeros" };
         ...
         * String[] nBasePriceObjs = { " basePrice Empty", " basePrice Zero",
         * " basePrice Negative",
         ...
         * String[] nSessPriceObjs = { " priceSess Empty", " priceSess Zero",
         * " priceSess Negative", " priceSess Alpha" };
         ...
         * String[] nHourPriceObjs = { " priceHr Empty", " priceHr Zero",
         * " priceHr Negative", " priceHr NaN" };
         ...
         * String[] nBespPriceObjs = { " bespoke Empty", " bespoke Zero",
         * " bespoke Negative" };
         ...
         * 
         * // 11. License Number
         * String[] nLicNums = { "", " ", "!!!", "A".repeat(5) }; // Assuming min length
         * or specificity
         * String[] nLicObjs = { " license Empty", " license Space", " license Special",
         * " license TooShort" };
         ...
         * String[] nCapObjs = { " capacity Empty", " capacity Zero",
         * " capacity Negative", " capacity Alpha" };
         ...
         * String[] nRadiiObjs = { " radius Empty", " radius Negative", " radius Alpha",
         * " radius TooLarge" };
